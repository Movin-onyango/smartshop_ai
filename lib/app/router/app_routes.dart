...
class AppRoutes {
  ...
  static const String inventoryReport =
      '/reports/inventory';

  static const String purchaseReport =
      '/reports/purchases';

  static const String expenseReport =
      '/reports/expenses';

  static const String customerReport =
      '/reports/customers';

  static const String supplierReport =
      '/reports/suppliers';
  ...
  static const String readNotifications =
      '/notifications/read';
  ...
  static String notificationHome() =>
      notifications;
  ...
  static const String receiptSettings =
      '/settings/receipt';

  static const String inventorySettings =
      '/settings/inventory';

  static const String salesSettings =
      '/settings/sales';

  static const String appearanceSettings =
      '/settings/appearance';

  static const String backupSettings =
      '/settings/backup';

  static const String securitySettings =
      '/settings/security';
