...
class AppRoutes {
  ...
  static const String addSale = '/sales/create';

  static const String checkout = '/sales/checkout';

  static const String saleDetails = '/sales/:id';

  static const String receipt = '/sales/:id/receipt';
  ...
  static String supplierDetails(String id) => '/suppliers/$id';

  static String editSupplier(String id) => '/suppliers/$id/edit';
  ...
  static String purchaseDetails(String id) => '/purchases/$id';

  static String editPurchase(String id) => '/purchases/$id/edit';
  ...
  static String expenseDetails(String id) => '/expenses/$id';
  ...
  static const purchaseReport = '/reports/purchases';

  static const expenseReport = '/reports/expenses';

  static const customerReport = '/reports/customers';

  static const supplierReport = '/reports/suppliers';
