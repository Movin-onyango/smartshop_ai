...
class SalesReportGetters extends BaseReportGetters {
  ...
  static List<List<String>> tableRows(SalesReportRepository repository) {
  ...
  static double totalSales(SalesReportRepository repository) {
    return repository.sales.fold(0, (sum, sale) => sum + sale.subtotal);
  }

  static double totalProfit(SalesReportRepository repository) {
    return repository.sales.fold(0, (sum, sale) => sum + sale.profit);
  }

  static int totalTransactions(SalesReportRepository repository) {
